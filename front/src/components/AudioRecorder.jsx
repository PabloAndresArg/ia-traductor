      ...
      <div className="recorder-status">
        {isRecording && (
          <>
            ...
            <p className="status-text">{recordingTime}s / {MAX_TIME}s</p>
          </>
        )}
      ...
      {audioUrl && !isRecording && (
        <div className="audio-preview">
          ...
          <div className="action-buttons">
            ...
            <button className="btn btn-send" onClick={sendToBackend} disabled={isLoading}>
            ...
            <div className="translation-content">
              ...
              <div className="translation-item">
                ...
                <audio
                  ...
                  src={`http://localhost:8000/download-audio/${translation.audio_file}`}
                  controls
                ...
                <button
                  ...
                  onClick={() => window.open(`http://localhost:8000/download-audio/${translation.audio_file}`, '_blank')}
                >
